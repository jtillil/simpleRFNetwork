...
boruta_TCGA(tcgadat_rnaseq, 1, method, importance, 500, 20, n_iterations, 1, saveroot)
...
borutares = list()
save(borutares, file = saveroot)
boruta_TCGA(tcgadat_micro, 1, method, importance, 500, 20, n_iterations, 1, saveroot)
